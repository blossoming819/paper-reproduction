...
parser.add_argument("--fuse_type", default="cross_attn", choices=["concat", "cross_attn", "sep_attn", "join"])
...
parser.add_argument("--main_model", default="hades",
                    choices=["hades", "hades-wom", "hades-wol", "hades-wof", "hades-woa", "hades-woc", "hades-woh", "hades-wos", "hades-anno"])

params = vars(parser.parse_args())


# ###### Ablation Experiments #######
# if params["main_model"] == "join-hades": # wof
#     params["fuse_type"] = "join"
# elif params["main_model"] == "concat-hades": # woa
#     params["fuse_type"] = "concat"
# elif params["main_model"] == "sep-hades": # woc
#     params["fuse_type"] = "sep_attn"
# elif params["main_model"] == "agn-hades": # woh
#     params["kpi_architect"] = "by_metric"
# elif params["main_model"] == "one-hades": # wos
#     params["feature_type"] = "sequential"
# elif params["main_model"] == "met-hades": #
#     params["data_type"] = "sequential"
# elif params["main_model"] == "anno-hades": # anno
#     params["supervised"] = "True"


###### Ablation Experiments #######
if params["main_model"] == "hades-wom":
    params["data_type"] = "log"
elif params["main_model"] == "hades-wol":
    params["data_type"] = "kpi"
elif params["main_model"] == "hades-wof":
    params["fuse_type"] = "join"
elif params["main_model"] == "hades-woa":
    params["fuse_type"] = "concat"
elif params["main_model"] == "hades-woc":
    params["fuse_type"] = "sep_attn"
elif params["main_model"] == "hades-woh":
    params["kpi_architect"] = "by_metric"
elif params["main_model"] == "hades-wos":
    params["feature_type"] = "sequential"
elif params["main_model"] == "hades-anno":
    params["supervised"] = True
...
def main(var_nums):
    ...
    ##### Record results #####
    dump_scores(params["result_dir"], params["main_model"], params["hash_id"], scores, model.train_time)
