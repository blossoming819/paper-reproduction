...
# input: [batch_size, seq_num, seq_lenth, embedding_dim]
# output: [batch_size, window_size, hidden_size]
class LogEncoder(nn.Module):
    def __init__(self, device, log_dropout=0, log_layer_num=2, transformer_hidden=1024, **kwargs):
        super(LogEncoder, self).__init__()
        self.hidden = kwargs["hidden_size"]  # 128
        self.self_attention = kwargs["self_attention"]  # True
